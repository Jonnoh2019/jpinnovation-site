...
async function signInToHub(data) {
  ...
  window.location.replace("../hub-portal/index.html?entry=hub&signin=1&v=hub-loop-fix-20260717");
}
...
async function restoreHubSession() {
  ...
  window.location.replace("../hub-portal/index.html?entry=hub&v=hub-loop-fix-20260717");
  return true;
}
