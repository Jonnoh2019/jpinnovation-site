...
(() => {
  "use strict";
  const VERSION = "profile-menu-navigation-critical-fix-20260721-stable7-menu-visible";
  ...
  function installViewportCss() {
    ...
    style.textContent = `
      ...
      .profile-menu.open {
        ...
        max-height: calc(100dvh - clamp(82px, 14dvh, 112px) - 14px - env(safe-area-inset-bottom)) !important;
      ...
      #memberProfileMenu.member-profile-menu .profile-menu-header,
      #profileMenu.profile-menu .profile-menu-header {
        flex: 0 0 auto !important;
      }
      #memberProfileMenu.member-profile-menu .profile-menu-link,
      #profileMenu.profile-menu .profile-menu-link,
      #memberProfileMenu.member-profile-menu #profileChatNotifications,
      #profileMenu.profile-menu #profileChatNotifications {
  ...
  function closeMenus() {
    ...
    document.querySelectorAll("#memberProfileMenu,#profileMenu,.profile-menu,.member-profile-menu").forEach((menu) => {
      ...
      menu.hidden = true;
      ["display","transform","translate","pointer-events","height","max-height","top","left","right","bottom","width","max-width","position"].forEach((prop) => menu.style.removeProperty(prop));
  ...
  function fixOpenMenuState() {
    ...
    if (shouldBeOpen) {
      ...
      menu.style.top = innerWidth <= 760 ? "96px" : "clamp(82px, 14dvh, 112px)";
      ...
      menu.style.maxHeight = innerWidth <= 760 ? "calc(100dvh - 110px - env(safe-area-inset-bottom))" : "calc(100dvh - clamp(82px, 14dvh, 112px) - 14px - env(safe-area-inset-bottom))";
