...
(() => {
  "use strict";
  const VERSION = "profile-menu-navigation-critical-fix-20260722-stable8-no-recovered-card";
  ...
  function adminHtml() { return `<section class="section-card section-lime"><div class="list-title"><div><h2>Pending actions</h2><p>Approvals, moderation and access checks first.</p></div><span class="pill good">Clear</span></div><div class="admin-quick-actions"><button class="jp-route" data-view-link="directory" type="button"><span>◎</span>Manage members</button><button class="jp-route" data-view-link="boards" type="button"><span>💬</span>Moderate discussions</button><button class="jp-route" data-view-link="projects" type="button"><span>▦</span>Review projects</button><button class="jp-route" data-view-link="quotes" type="button"><span>£</span>Review quotes</button><button class="jp-route" data-view-link="metrics" type="button"><span>📈</span>Website metrics</button></div></section>`; }
