...
(function () {
  function addStyles() {
    ...
    style.textContent = `
      ...
      .member-card.member-compact-card{padding:10px!important;gap:6px!important;min-height:0!important;border-radius:17px!important}
      .member-card.member-compact-card .compact-member-top{grid-template-columns:44px minmax(0,1fr)!important;gap:8px!important;align-items:center!important}
      .member-card.member-compact-card .compact-avatar-wrap,.member-card.member-compact-card .compact-avatar-wrap .profile-avatar{width:44px!important;height:44px!important;min-width:44px!important;border-radius:13px!important;font-size:17px!important}
      ...
      .member-card.member-compact-card .compact-member-bio{display:-webkit-box!important;-webkit-line-clamp:2!important;-webkit-box-orient:vertical!important;overflow:hidden!important;margin:0!important;font-size:11.5px!important;line-height:1.24!important;max-height:2.5em!important}
