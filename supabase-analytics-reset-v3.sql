...
-- Run this in Supabase SQL editor to repair Reset Today / Reset All Visits.
-- Safe to run more than once.
-- Resets visitor/page-view analytics only. It does not delete users, profiles, posts, replies, projects, quotes, messages or registrations.
